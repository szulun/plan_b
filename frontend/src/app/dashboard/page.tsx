...
export default function Home() {
  ...
  const [holdings, setHoldings] = useState<Stock[]>([CASH_ASSET]);
  ...
  const handleAddTrade = (trade: Omit<TradeRecord, 'id'>) => {
    setTrades(prev => [...prev, { ...trade, id: `trade-${Date.now()}-${Math.random()}` }]);
  };
